...
/**
 *
 * @author Data Virtue  - Public Domain - Copyright is hereby relinquished to the public domain.
...
public class LinePrinter {
    ...
    public LinePrinter(Font fnt, boolean prompt) {
        ...
        p.setSize(W = 612, H = 792);  //8.5" x 11" Portrait
	...
	private void reconfigurePage() {
	    ...
	    availableLines = (Y_space - lineSize) / lineSize;  //the PROPER formula for calculating available lines on a page using the current font
    ...
    If a line doesn't fit on the page a new page is created and "printing" continues on the next page. */
